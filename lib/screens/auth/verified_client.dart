...
class EmailVerificationScreen_client extends StatefulWidget {
  const EmailVerificationScreen_client({Key? key}) : super(key: key);

  @override
  State<EmailVerificationScreen_client> createState() =>
      _EmailVerificationScreenState();
}

class _EmailVerificationScreenState
    extends State<EmailVerificationScreen_client> {
